...
var MuiPickersAdapterContext = React42.createContext(null);
if (true) {
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = React42.useContext(MuiPickersAdapterContext) ?? {
    utils: void 0,
    localeText: void 0
  };
  ...
  const localeText = React42.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const utils = React42.useMemo(() => {
    if (!DateAdapter) {
      if (parentUtils) {
        return parentUtils;
      }
...
`));
  ...
  const defaultDates = React42.useMemo(() => {
    if (!utils) {
      return null;
    }
    return {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SIFYSYXQ.js.map
